            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 p-4">
                ...
                <a
                  ...
                  className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
                >
                  <Image className="rounded-full w-11 h-11" src="/roland.png" />
                  <div className="text-sm text-gray-900 dark:text-white">
                    Users
                  </div>
                </a>
            ...
            <Dropdown>
              <DropdownTrigger className="rounded-full">
                <Button
                  ...
                  className=' bg-none rounded-full bg-transparent w-11 h-11 '
                >
                  <span className="sr-only ">Open user menu</span>
                  <Image className="bordered rounded-full w-11 h-11" src="/image.png" />
                </Button>
              </DropdownTrigger>
              <DropdownMenu aria-label="Static Actions">
                <DropdownItem className="" key="new">New file</DropdownItem>
                <DropdownItem className="" key="copy">Copy link</DropdownItem>
                <DropdownItem className="" key="edit">Edit file</DropdownItem>
                <DropdownItem
                  key="delete"
